  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white mt-10 mb-20 lg:mb-32">
        ...
        {/* Updated description - remove "Watch" reference */}
        <div className="max-w-3xl mx-auto mb-8 lg:mb-12 p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
          <p className="text-base sm:text-lg text-white/90 leading-relaxed">
            <strong>Experience Compassionate Care:</strong> Springs Companions provides professional in-home care 
