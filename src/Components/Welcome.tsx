    ...
    <section className="py-12 sm:py-16 lg:py-20 xl:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-12 lg:mb-16">
          <h1 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl xl:text-7xl font-bold text-teal-700 leading-tight">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-base sm:text-lg lg:text-xl xl:text-3xl text-gray-600 mb-4 sm:mb-5 lg:mb-8 leading-relaxed sm:leading-loose">
            ...
            <p className="text-base sm:text-lg lg:text-xl xl:text-3xl text-gray-600 mb-6 sm:mb-7 lg:mb-10 leading-relaxed sm:leading-loose">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 sm:-bottom-5 sm:-right-5 lg:-bottom-6 lg:-right-6 bg-teal-700 text-white p-4 sm:p-5 lg:p-6 xl:p-8 rounded-xl sm:rounded-2xl shadow-xl max-w-[140px] xs:max-w-[160px] sm:max-w-[180px] lg:max-w-[200px] xl:max-w-xs z-10">
                <p className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold mb-1 sm:mb-2">15+</p>
