    ...
    <section className="py-12 sm:py-16 lg:py-20 xl:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <h1 className="text-xl xs:text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-teal-700 mb-4 sm:mb-6 lg:mb-8 leading-tight">
            WHY CHOOSE US
          </h1>
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 xl:gap-12 mb-10 sm:mb-12 lg:mb-16">
          ...
          <div className="text-center group p-4 sm:p-6 lg:p-0">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6 leading-tight">Experience</h3>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-gray-600 leading-relaxed sm:leading-loose">
          ...
          <div className="text-center group p-4 sm:p-6 lg:p-0">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6 leading-tight">Flexibility</h3>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-gray-600 leading-relaxed sm:leading-loose">
          ...
          <div className="text-center group p-4 sm:p-6 lg:p-0">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6 leading-tight">Specialized Care</h3>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-gray-600 leading-relaxed sm:leading-loose">
          ...
          <div className="text-center group p-4 sm:p-6 lg:p-0">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6 leading-tight">Commitment</h3>
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-gray-600 leading-relaxed sm:leading-loose">
        ...
        <div className="text-center px-2 sm:px-0">
          <a 
            href="/contact" 
            className="bg-teal-700 text-white px-6 sm:px-10 lg:px-12 py-4 sm:py-5 lg:py-6 rounded-full hover:bg-teal-800 transition-all inline-flex items-center gap-2 sm:gap-3 font-semibold text-sm sm:text-base lg:text-lg xl:text-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 duration-300"
          >
