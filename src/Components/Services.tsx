    ...
    <section id="services" className="py-12 sm:py-16 lg:py-20 xl:py-32 bg-gradient-to-br from-gray-50 to-teal-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-14 lg:mb-16 xl:mb-20">
          ...
          <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed sm:leading-loose">
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="bg-white p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 lg:hover:-translate-y-2">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6 leading-tight">Personal Care Services</h3>
            <p className="text-xs sm:text-sm lg:text-base xl:text-lg text-gray-600 leading-relaxed sm:leading-loose">Bathing, dressing, grooming, feeding, and comprehensive hygiene support tailored to individual needs.</p>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 lg:hover:-translate-y-2">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6 leading-tight">Cognitive & Mobility Care</h3>
            <p className="text-xs sm:text-sm lg:text-base xl:text-lg text-gray-600 leading-relaxed sm:leading-loose">Specialized dementia & Alzheimer's support, mobility assistance, exercises, and fall risk prevention.</p>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 lg:hover:-translate-y-2">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6 leading-tight">Respite Care</h3>
            <p className="text-xs sm:text-sm lg:text-base xl:text-lg text-gray-600 leading-relaxed sm:leading-loose">Flexible temporary relief for family caregivers, including 24-hour care options for peace of mind.</p>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 lg:hover:-translate-y-2">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6 leading-tight">Medical & Health Support</h3>
            <p className="text-xs sm:text-sm lg:text-base xl:text-lg text-gray-600 leading-relaxed sm:leading-loose">Chronic illness management, post-surgery care, medication reminders, and palliative care support.</p>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 lg:hover:-translate-y-2">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6 leading-tight">Companionship</h3>
            <p className="text-xs sm:text-sm lg:text-base xl:text-lg text-gray-600 leading-relaxed sm:leading-loose">Social engagement, recreational activities, emotional support, and meaningful connection.</p>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 lg:hover:-translate-y-2">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 lg:mb-6 leading-tight">Lifestyle Assistance</h3>
            <p className="text-xs sm:text-sm lg:text-base xl:text-lg text-gray-600 leading-relaxed sm:leading-loose">Meal preparation, light housekeeping, errands, transportation, and daily activity support.</p>
          </div>
        </div>
